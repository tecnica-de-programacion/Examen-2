...
class MainView(Tk):
    ...
    def __interfaz_configure(self):
        ...
        self.__board = BackGround(self, self.Positions.x_canv_and_backg, self.Positions.y_backg, image = self.__fondo, width = self.Constants.widthC)

        self.__canvas = Canvas(self, width = self.Constants.widthC , height = self.Constants.heigthC, bg = self.Constants.bg)
